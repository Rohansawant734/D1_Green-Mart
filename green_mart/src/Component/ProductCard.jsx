  ...
  return (
    <div className='relative bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition group'>
      ...
      <div className='p-3'>
        ...
        <button onClick={() => addToCart(product)} className="mt-4 bg-green-500 text-white px-4 py-1 rounded flex items-center justify-center gap-2 hover:bg-green-600 transition">
